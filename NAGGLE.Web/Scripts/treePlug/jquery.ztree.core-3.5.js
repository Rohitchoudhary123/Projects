...
(function ($) {
	...
	view = {
	    ...
	    makeDOMNodeMainBefore: function (html, setting, node) {
	        html.push("<li id='", node.tId, "' class='", consts.className.LEVEL, node.level, "' style='display:", node.isHidden == true ? 'none' : 'block', "' tabindex='0' hidefocus='true' treenode>");
	    },
    ...
    $.fn.zTree = {
        ...
        initializeEvents: function (textbox, zTreeContainer) {
            var ths = this;
            textbox.on("click", function () {
                if (textbox.val() == "") {

                    ths.setPositionOfMainContainer(textbox, zTreeContainer);
                    zTreeContainer.width(textbox.width())
                    zTreeContainer.show();
                }
            });
            //var caret = $('<b class="caret treeview-caret"></b>');
            //  textbox.parent().after(caret);
            //  caret.on("click", function () { zTreeContainer.show(); });
        ...
        createContainer: function (obj) {
            ...
            var divZTree = $('<div class="ztree"></div>');
            ...
            this.initializeEvents(obj, maincontainer);
            return divZTree;
        },

        setPositionOfMainContainer: function (target, container) {
